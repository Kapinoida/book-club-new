...
export default function CreatePollPage() {
  ...
  useEffect(() => {
    // Set default dates (poll opens in 1 week, runs for 1 week)
    const now = new Date();
    ...
    twoMonthsOut.setMonth(now.getMonth() + 2);
    twoMonthsOut.setDate(1);
    setForMonth(twoMonthsOut.toISOString().split("T")[0]);
  }, []);
    ...
    <div className="container mx-auto py-8 space-y-8 max-w-4xl">
        ...
        <CardHeader>
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <CardDescription>
                Set up a poll for members to vote on the next book
              </CardDescription>
            </div>
          </div>
        </CardHeader>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex gap-2 justify-end">
          ...
          <Button type="submit" disabled={isCreating || selectedBookIds.length < 2}>
